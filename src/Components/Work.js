...
function Work({ position, company, organization, location, type, duration, Description }) {
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-xs md:text-sm font-light pl-1">{company || organization}</p>
          </div>
      ...
      {Description && Array.isArray(Description) && (
        <ul className="mt-3 list-disc list-inside text-content text-xs md:text-sm font-light pl-2">
